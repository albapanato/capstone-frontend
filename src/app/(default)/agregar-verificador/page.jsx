import VerificatorForm from "../../../components/forms/VerificatorForm";
import Link from "next/link";
import { ArrowLeft } from "lucide-react"; // npm install lucide-react

export default function AddVerificaroPage() {
  return (
    <div className=" min-w-[668px] flex items-center justify-center bg-gray-50">
      <div className="min-w-[95%] space-y-8 p-8 bg-white rounded-lg shadow-lg m-4">
        <Link
          href="/agregar-suceso"
